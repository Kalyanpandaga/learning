...
from lr_users_auth.interactors.presenter_interfaces\
    .login_presenter_interface import \
    LoginPresenterInterface
from lr_users_auth.interactors.storage_interfaces.dtos import \
    TokensDTO
...
class LoginInteractor:
    ...
    def login_wrapper(self, client_id: str, code: str,
        ...
        from lr_users_auth.exceptions.custom_exceptions import UserAccountIsDeactivatedException
        try:
    ...
    def login(client_id: str, code: str) -> TokensDTO:
        from lr_users_auth.adapters.service_adapter import \
            get_service_adapter
        ...
        from lr_users_auth.adapters.service_adapter import ServiceAdapter
