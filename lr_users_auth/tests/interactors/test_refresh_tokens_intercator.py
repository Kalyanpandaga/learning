...
from lr_users_auth.interactors.presenter_interfaces.refresh_auth_tokens_presenter_interface import \
    RefreshAuthTokensPresenterInterface
from lr_users_auth.interactors.refresh_auth_tokens_interactor import \
...
class TestRefreshAuthTokensInteractor:
    ...
    @patch(
        "lr_users_auth.adapters.user_service.AuthService.refresh_auth_tokens"
    )
