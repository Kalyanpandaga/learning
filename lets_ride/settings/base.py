"""
Django settings for lets_ride project.
...
ALLOWED_HOSTS = [
    "lets-ride-prod.apigateway.in",
    "lets-ride-alpha.apigateway.in",
    "lets-ride-beta.apigateway.in",
    "lets-ride-gamma.apigateway.in",
    "lets-ride-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]

ROOT_URLCONF = 'lets_ride.urls'

CSRF_COOKIE_SECURE = False

WSGI_APPLICATION = 'lets_ride.wsgi.application'
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [lets_ride - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
LETS_RIDE_SOURCE = "lets-ride-source"
